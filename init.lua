...
minetest.register_alias("technic:uranium_block","default:goldblock")
minetest.unregister_item("technic:uranium35_block")
minetest.register_alias("technic:uranium35_block","default:goldblock")
minetest.unregister_item("technic:uranium0_block")
minetest.register_alias("technic:uranium0_block","default:goldblock")
